...
export default function CreatePost({ loggedIn, flashMessage }) {
    ...
    return (
        <>
            <h3 className="text-center mt-3 mb-5">Create A Post</h3>
            <form action="" onSubmit={handleSubmit}>
                <div className="form-group">
                    <input type="text" name="title" className="form-control my-3 mb-5" placeholder='Enter Title' />
                    <textarea name="content" className="form-control my-3" placeholder='Enter Body' />
                    <input type="submit" value="Create Post" className='btn btn-secondary w-100 mt-5' />
                </div>
            </form>
        </>
    )
